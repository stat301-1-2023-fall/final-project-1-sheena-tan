...
DONE - Which school has the best classes? **take means of course_rating for each school and compare using bar plot.** ALSO **filter for positive and negative affect codewords to complete a sentiment analysis on the CTECs** in order to better inform the course ratings
