...
### How are our measures related?

### Who is the most liked and most hated teacher in each department? 

**use the new instructor rating to find which teachers have the highest and lowest ratings**
...
**filter for classes with unique instructor values but same course and department numbers**, then **compare instructor ratings**

### What are the best classes overall and in each department?
create enjoyment rating based on combination of inst_rating, course_rating, learn_rating, and interest_rating

### Does class level (100-200-300) determine if students feel like they learn more? 
group .by level and run analysis